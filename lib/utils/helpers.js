...
const formDescription = function formDescription({ dimensions, shape, square, material, flip}) {
    let descString = {
        flip,
        shape,
        material,
...
export function prepareProduct({ shape, dimensions, imageUrl, material, flip }) {
    const { square, price } = calculateSquareAndPrice({ shape, dimensions });
    const description = formDescription({ dimensions, shape, square, material, flip });
